const CACHE_NAME = 'Test-cache-v2.2';
const urlsToCache = [
  'index.html?v=2.2',
  'edit.html?v=2.2',
  'privacy-policy.html?v=2.2',
  'cookie-policy.html?v=2.2',
  'info.html?v=2.2',
  'informazioni.html?v=2.2',
  'download.html?v=2.2',
  'scarica.html?v=2.2',
  'css/style.css?v=2.2',
  'css/policy.css?v=2.2',
  'js/crypto.js?v=2.2',
  'js/edit.js?v=2.2',
  'js/home.js?v=2.2',
  'js/info.js?v=2.2',
  ...
  event.respondWith(
    caches.match(event.request)
      .then(cachedResponse => {
        ...
        return caches.match('index.html?v=2.2');
      })
      .catch(error => {
