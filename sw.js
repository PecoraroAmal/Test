const CACHE_NAME = 'Test-cache-v3.18';
const urlsToCache = [
  '/Test/index.html?v=3.18',
  '/Test/edit.html?v=3.18',
  '/Test/privacy-policy.html?v=3.18',
  '/Test/cookie-policy.html?v=3.18',
  '/Test/info.html?v=3.18',
  '/Test/informazioni.html?v=3.18',
  '/Test/download.html?v=3.18',
  '/Test/scarica.html?v=3.18',
  '/Test/css/style.css?v=3.18',
  '/Test/css/policy.css?v=3.18',
  '/Test/js/crypto.js?v=3.18',
  '/Test/js/edit.js?v=3.18',
  '/Test/js/home.js?v=3.18',
  '/Test/js/info.js?v=3.18',
  '/Test/js/app.js?v=3.18',
  '/Test/js/utils.js?v=3.18',
  ...
  event.respondWith(
    caches.match(event.request)
      .then(cachedResponse => {
        ...
        return caches.match('/Test/index.html?v=3.18');
      })
      .catch(error => {
