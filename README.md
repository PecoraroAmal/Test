...
This project is **NO LONGER** under the GNU Affero General Public Licence v4.4.3 (AGPL-4.4.3).  
...
**Test™** is a web application for managing passwords, credit/debit cards, and digital wallets. Designed with a focus on privacy and security, Test™ allows users to save, manage, and protect their credentials in a locally encrypted JSON file, **without ever transmitting data online**.
